...
function App() {
  ...
  return (
    <div className='container my-10 mx-auto'>
      <div className='md:flex mx-3 md:space-x-3 max-md:space-y-3'>
        <div className='w-full space-y-3'>
          ...
          <Surface className='w-full space-y-3'>
            ...
            <div className='grid max-md:grid-cols-4 md:grid-cols-12 gap-3'>
          ...
          <div className='md:flex w-full max-md:space-y-3 md:space-x-3'>
            <Surface className='md:w-6/12 space-y-3'>
              {/* QR code corner square options */}
              <p className='font-semibold text-lg text-slate-600'>Corner Square</p>
              <div className='grid max-md:grid-cols-4 md:grid-cols-6 gap-3'>
                <div className={'w-full'}>
                  <OptionButton
                    image={none}
        ...
        <Surface className='space-y-3 h-full'>
          ...
          <div className='md:w-96 py-8 flex justify-center'>
            <div ref={ref}/>
          </div>
          {/* Download options */}
          <div className='md:w-96 flex space-x-3'>
